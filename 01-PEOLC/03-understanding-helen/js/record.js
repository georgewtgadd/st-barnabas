...
function populateLearningRecord() {
  ...
  if (typeof renderBadgeCase === 'function') renderBadgeCase('badge-case');
...
function exportLearningRecordPDF() {
  ...
  function renderBody() {
    ...
    if (typeof drawBadgesInPdf === 'function') {
      y = drawBadgesInPdf(doc, margin, y, navy, muted);
    }
    y += 6;
