/* ══════════════════════════════════════════════════════════
   ...
   Replaces js/scorm.js. Safe to load outside an LRS — gracefully no-ops
   and logs statements to the console instead of sending them.
...
const XAPI = (() => {
  ...
  const ACTIVITY_BASE = 'https://www.stbarnabashospice.co.uk/xapi/intro-peolc';
  const COURSE_ACTIVITY = {
    id: ACTIVITY_BASE,
    definition: {
      name: { 'en-GB': 'What is End of Life Palliative Care?' },
  ...
  /* ── Public: convenience helpers mirroring the old SCORM API ─ */
  ...
  // A learner chose an option within an interaction (e.g. a scenario stage)
